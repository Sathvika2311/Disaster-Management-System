...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Validate form data
    if (empty($_POST['description']) || empty($_POST['severity'] || empty($_POST['emergencyType']))) {
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
            ...
            <div class="bg-gray-900 rounded-lg shadow-2xl p-6 space-y-8 border border-gray-800 transform transition-all hover:shadow-red-900/20">
                ...
                <form id="emergencyForm" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="space-y-6">
                    ...
                    <!-- Emergency Type -->
                    <div class="space-y-2">
                        <label class="text-white font-medium">Disaster Type <span class="text-red-500">*</span></label>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <button type="button" class="emergency-type-btn bg-gray-800 hover:bg-red-600 text-white p-4 rounded-lg flex flex-col items-center transition-colors" data-type="Earthquake" required>
                                
                                Earthquake
                            </button>
                            <button type="button" class="emergency-type-btn bg-gray-800 hover:bg-red-600 text-white p-4 rounded-lg flex flex-col items-center transition-colors" data-type="Floods">
                                
                                Floods
                            </button>
                            <button type="button" class="emergency-type-btn bg-gray-800 hover:bg-red-600 text-white p-4 rounded-lg flex flex-col items-center transition-colors" data-type="Cyclone">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="text" id="contactName" name="contactName" placeholder="Your Name" value="<?php echo htmlspecialchars($currentUser['first_name']); ?>" 
                                class="w-full px-4 py-2 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-red-500">
                    ...
                    <div class="space-y-2">
                        <label class="text-white font-medium">Resources Needed</label>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="resources[]" value="food" 
                                    class="form-checkbox h-4 w-4 text-red-600 bg-gray-800 border-gray-700 rounded">
                                <span class="text-gray-300">Food</span>
                            </label>
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="resources[]" value="medicines" 
                                    class="form-checkbox h-4 w-4 text-red-600 bg-gray-800 border-gray-700 rounded">
                                <span class="text-gray-300">Medicines</span>
                            </label>
                            <label class="flex items-center space-x-2">
