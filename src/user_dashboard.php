...
<body class="bg-black min-h-screen">
    ...
    <main>
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <!-- Dashboard Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-white mb-2">Reporter Dashboard</h1>
                <p class="text-gray-400 mb-6">Welcome, <?php echo htmlspecialchars($currentUser['first_name'] . ' '); ?></p>
                                ...
                                <tbody id="emergencyList" class="text-gray-300">
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        while ($incident = $result->fetch_assoc()) {
                                            ...
                                            echo "</div>";
                                            echo "</td>";
											echo "<td class='py-3 px-4'>" . htmlspecialchars($incident['title']) . "</td>";
